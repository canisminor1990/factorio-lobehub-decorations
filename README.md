...
<img height="120" src="https://github.com/user-attachments/assets/10281c9a-76f6-49e8-87ea-f7e5a82caa4e">

<h1>Factorio Lobehub Decorations</h1>

Decorative structures used internally by the LobeHub team.
...
![](https://github.com/user-attachments/assets/8d930279-2744-4552-9712-c8246244f420)
...
```bash
$ git clone https://github.com/canisminor1990/factorio-lobehub-decorations.git
$ cd factorio-lobehub-decorations
$ bun install
$ bun dev
```
